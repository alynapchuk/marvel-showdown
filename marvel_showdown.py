...
class Hero:
    ...
    def alive(self):
        if (self.health > 0):
            ...
            print("Oh no... %s has been defeated! Better luck next time!" % (self.name))
            print()
            print("""
 _____                        _____                   
|  __ \                      |  _  |                  
...
class Villian:
    ...
    def alive(self):
        if (self.health > 0):
            ...
            print("Nice job! %s has been defeated!" % (self.name))
            print()
            print("""
__   __                                    _   _   _                               _     _ _ 
\ \ / /                                   | | | | | |                             | |   | | |
 \ V /___  _   _   ___  __ ___   _____  __| | | |_| |__   ___  __      _____  _ __| | __| | |
  \ // _ \| | | | / __|/ _` \ \ / / _ \/ _` | | __| '_ \ / _ \ \ \ /\ / / _ \| '__| |/ _` | |
  | | (_) | |_| | \__ \ (_| |\ V /  __/ (_| | | |_| | | |  __/  \ V  V / (_) | |  | | (_| |_|
  \_/\___/ \__,_| |___/\__,_| \_/ \___|\__,_|  \__|_| |_|\___|   \_/\_/ \___/|_|  |_|\__,_(_)
